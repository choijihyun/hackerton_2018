...
<body class="w3-content" style="max-width: 1200px">
	...
	<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top"
		...
		<div class="w3-padding-64 w3-large w3-text-grey"
			...
			<a onclick="myAccFunc()" href="javascript:void(0)"
				class="w3-button w3-block w3-white w3-left-align" id="myBtn"> 학과
				<i class="fa fa-caret-down"></i>
			</a>
			<div id="demoAcc"
				class="w3-bar-block w3-hide w3-padding-large w3-medium">
				<a href="#" class="w3-bar-item w3-button"></a> <input
					type="checkbox" id="cb1"> <label for="cb1">컴퓨터공학과</label> <a
					href="#" class="w3-bar-item w3-button"></a> <input type="checkbox"
					id="cb2"> <label for="cb2">소프트웨어학과</label> <a href="#"
					class="w3-bar-item w3-button"></a> <input type="checkbox" id="cb3">
				<label for="cb3">지능기전</label> <a href="#"
					class="w3-bar-item w3-button"></a> <input type="checkbox" id="cb4">
				<label for="cb4">정보보호학과</label>
			</div>
			<a onclick="myAccFunc1()" href="javascript:void(0)"
				class="w3-button w3-block w3-white w3-left-align" id="myBtn"> 학년
				<i class="fa fa-caret-down"></i>
			</a>
			<div id="demoAcc1"
				class="w3-bar-block w3-hide w3-padding-large w3-medium">
				<a href="#" class="w3-bar-item w3-button"></a> <input
					...
					class="w3-bar-item w3-button"></a> <input type="checkbox" id="cb03">
				<label for="cb1">3</label> <a href="#" class="w3-bar-item w3-button"></a>
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<header class="w3-container w3-xlarge">
			...
			<p class="w3-right">
				<a class="btn btn-default btn-log-out" aria-label="Left Align"
					id="logout">
				</a>
