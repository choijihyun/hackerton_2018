	...
	<div>
		...
		<nav class="w3-sidebar w3-bar-block w3-collapse w3-top"
			...
			<div class="w3-padding-64 w3-large w3-text-grey"
				...
				<div id="demoAcc"
					...
					<a href="#" class="w3-bar-item w3-button"></a> <input
						type="checkbox" id="cb3"> <label for="cb3">지능기전</label> <a
						href="#" class="w3-bar-item w3-button"></a> <input type="checkbox"
						id="cb4"> <label for="cb4">정보보호학과</label>
				</div>
		...
		<div class="w3-main w3-container" style="margin-left: 250px">
			...
			<div class="row main_area mt-4">
				...
				<div class="col-3 label_input mt-2"> <label>작년 커트라인</h6> </label> </div>
				<div class="col-3 mt-2">
					<input type="text" class="form-control form-control-sm flat_input" disabled="true" id="lastCutLine">
				</div>
				<div class="col-3 label_input mt-2"> <label>작년 합격자 수</label> </div>
				<div class="col-3 mt-2">
					<input type="text" class="form-control form-control-sm flat_input" disabled="true" id="lastPasser">
				</div>
				
				<div class="col-3 label_input mt-2"> <label>커트라인</label> </div>
				<div class="col-3 mt-2">
					<input type="text" class="form-control form-control-sm flat_input" 
					placeholder="커트라인을 입력 해 주세요." id="thisCutLine">
				</div>
				<div class="col-3 label_input mt-2"> <label>예상 합격자 수</label> </div>
				<div class="col-3 mt-2">
					<input type="text" class="form-control form-control-sm flat_input" disabled="true" id="thisPasser">
				</div>
